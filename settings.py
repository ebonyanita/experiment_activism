...
SESSION_CONFIGS = [dict(name='activism', num_demo_participants=8, app_sequence=['activism', 'questionnaire'], participation_fee=5.0, monitor_session_fields=['num_roadblockers', 'treatment'], monitor_participant_fields=['treatment'])]
LANGUAGE_CODE = 'en'
