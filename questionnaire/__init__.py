...
class Player(BasePlayer):
    ...
    q2_activism_choice = models.StringField(blank=True, choices=['Petition (0 cost to you)', 'Demonstration (Cost: -10 sec to you)', 'Road blocking (Cost: -10 sec to you; -5 sec to others)', 'None of the above'], label='Which type of activism would you choose?')
    q3_personal_cost = models.IntegerField(blank=True, choices=[1, 2, 3, 4, 5], label='How costly did you find participating in activism to be?', max=C.SCALE_MAX, min=C.SCALE_MIN, widget=widgets.RadioSelectHorizontal)
    q4_cost_to_others = models.IntegerField(blank=True, choices=[1, 2, 3, 4, 5], label='To what extent did the activism in your group affect other players?', max=C.SCALE_MAX, min=C.SCALE_MIN, widget=widgets.RadioSelectHorizontal)
    q5_extremity = models.IntegerField(blank=True, choices=[1, 2, 3, 4, 5], label='How extreme did you find the activist behavior within your group to be?', max=C.SCALE_MAX, min=C.SCALE_MIN, widget=widgets.RadioSelectHorizontal)
    q6_legitimacy = models.IntegerField(blank=True, choices=[1, 2, 3, 4, 5], label='To what extent do you feel the activism done by your group was justified?', max=C.SCALE_MAX, min=C.SCALE_MIN, widget=widgets.RadioSelectHorizontal)
    q7_social_id = models.IntegerField(blank=True, choices=[1, 2, 3, 4, 5], label='How similar do you feel to activists in your group?', max=C.SCALE_MAX, min=C.SCALE_MIN, widget=widgets.RadioSelectHorizontal)
    q8_compassion = models.IntegerField(blank=True, choices=[1, 2, 3, 4, 5], label='Compassion', max=C.SCALE_MAX, min=C.SCALE_MIN, widget=widgets.RadioSelectHorizontal)
    q8_sympathy = models.IntegerField(blank=True, choices=[1, 2, 3, 4, 5], label='Sympathy', max=C.SCALE_MAX, min=C.SCALE_MIN, widget=widgets.RadioSelectHorizontal)
    q8_annoyance = models.IntegerField(blank=True, choices=[1, 2, 3, 4, 5], label='Annoyance', max=C.SCALE_MAX, min=C.SCALE_MIN, widget=widgets.RadioSelectHorizontal)
